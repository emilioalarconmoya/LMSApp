...
{
    public class DLSOLICITUDCURSOList : DLGenericBaseList<ESOLICITUDCURSO>
    {
        public DLSOLICITUDCURSOList()
        {
            this._proc_select_all = "proc_select_SOLICITUD_CURSO_all";
        }
        ...
        public List<ESOLICITUDCURSO> SelectAll()
        {
        ...
        public DataTable ListaSolicitudesCursos(long rutUsuario, string nombreUsuario, int Estado, Int64 CodEmpresa)
        {
            DB db = DatabaseFactory.Instance.GetDatabase();
            IDbDataParameter[] prms;
            prms = db.GetArrayParameter(4);
            ...
            DataTable dt = db.ExecuteDataTable(CommandType.StoredProcedure, "proc_buscador_solicitudes_cursos", prms);
