...
{
	/// <summary>
	/// Summary description for EMALLAACTUSUARIO.
    /// </summary>
    [Serializable()]
    public class EMALLAACTUSUARIO : DomainObject
    {
        ...
        public EMALLAACTUSUARIO() : base()
	    {
	    }
	    
		public EMALLAACTUSUARIO(long id) : base(id)
		{
		}
