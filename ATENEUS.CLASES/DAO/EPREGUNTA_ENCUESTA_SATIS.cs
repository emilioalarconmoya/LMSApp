...
namespace ATENEUS.CLASES.DAO
{
    ...
    /// </summary>
    [Serializable()]
    public class EPREGUNTAENCUESTASATIS : DomainObject
    {
	    ...
	    public EPREGUNTAENCUESTASATIS() : base()
	    {
	    }
	    
		public EPREGUNTAENCUESTASATIS(long id) : base(id)
		{
		}
        ...
        {
            return new DLPREGUNTAENCUESTASATIS();
        }
